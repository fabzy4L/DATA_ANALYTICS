...
############################
############################
qPCR     <- read.csv("../../data/raw/fold_change/qPCR all values - qPCR.csv")
H_qPCR   <- read.csv("../../data/raw/fold_change/qPCR all values - qPCR - HUMAN.csv")
R2_qPCR  <- read.csv("../../data/raw/fold_change/qPCR all values - qPCR - RAT - 2.csv") # JUST RELEVANT GENES (4) (16 C vs 8 N)
R_qPCR   <- read.csv("../../data/raw/fold_change/qPCR all values - qPCR - RAT.csv")     # ALL GENES W/ READINGS
A_R_qPCR <- read.csv("../../data/raw/fold_change/qPCR all values - qPCR DATA - ALLRAT.csv") # ALL GENES W/ SOME MISSING READINGS
```

...
```{r}
library(heatmaply)
heatmaply(hpcrnor, main="Human",  xlab="Genes", col=c("black","red"), row_side_palette= mfcol, labRow = NULL, show_dendrogram = c(FALSE, FALSE), showticklabels = c(T,F), hide_colorbar=FALSE, dpi=300, file = "../../outputs/figures/heatmap_human.pdf")
